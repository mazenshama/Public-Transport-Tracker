...
export class ApiService {
  ...
  async getBuses(): Promise<{ buses: Bus[] }> {
    try {
      const response = await this.http.get<{ buses: Bus[] }>(`${this.apiUrl}/api/admin/buses`).toPromise();
  ...
  async getRoutes(): Promise<{ routes: RouteModel[] }> {
    try {
      const response = await this.http.get<{ routes: RouteModel[] }>(`${this.apiUrl}/api/admin/routes`).toPromise();
  ...
  async getContacts(): Promise<{ contacts: Contact[] }> {
    try {
      const response = await this.http.get<{ contacts: Contact[] }>(`${this.apiUrl}/api/admin/contacts`).toPromise();
  ...
  async getAllTracking(): Promise<{ tracking: Tracking[] }> {
    try {
      const response = await this.http.get<{ tracking: Tracking[] }>(`${this.apiUrl}/api/admin/tracking`).toPromise();
